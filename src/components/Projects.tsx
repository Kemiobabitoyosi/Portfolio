...
import Project2 from "../app/token-swap.webp";
...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    githubLink: "https://github.com/demiladebdm/Blog-Application-Client"
  },
  {
    ...
    <section className="teams" id="teams">
      <div className="max-width">
        ...
        <div className="githubDiv">
          <a href="https://github.com/demiladebdm" target="_blank" rel="noopener noreferrer">
