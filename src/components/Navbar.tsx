...
const Navbar: React.FC<NavbarProps> = ({ scrollBelowHomePage }) => {
  ...
  return (
    <nav className={`navbar ${menuOpen || isScrolled ? "active" : ""} ${isScrolled && scrollBelowHomePage ? "full-bg" : ""}`}>
      <div className="max-width">
        ...
        <ul className={`menu ${menuOpen ? "active" : ""}`}>
          ...
          <li><a href="#teams" className="menu-btn" onClick={closeMenu}>Projects</a></li>
